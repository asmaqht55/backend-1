...
public class HrController {
    ...
    public ResponseEntity<List> getByCategory(@PathVariable String category){
        List<Hr> hrList= Hrservice.getHrByCategory(category);
        return ResponseEntity.status(200).body(hrList);
    }
